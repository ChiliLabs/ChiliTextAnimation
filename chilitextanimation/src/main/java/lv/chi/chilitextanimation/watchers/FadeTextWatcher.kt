...
import lv.chi.chilitextanimation.spans.FadeAnimationSpan
import lv.chi.chilitextanimation.spans.VerticalSlideAnimationSpan

class FadeTextWatcher(
    target: TextView,
    ...
    override fun evaluate(
        ...
        .apply {
            setSpan(
                FadeAnimationSpan(fraction, changedIndices, oldText, targetView.letterSpacing),
                startIndex,
                endIndex,
