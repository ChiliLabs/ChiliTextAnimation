...
import lv.chi.chilitextanimation.spans.ShrinkAnimationSpan

class ShrinkTextWatcher(
    target: TextView,
    ...
    override fun evaluate(
        ...
        .apply {
            setSpan(
                ShrinkAnimationSpan(fraction, changedIndices, oldText, targetView.letterSpacing),
                startIndex,
                endIndex,
